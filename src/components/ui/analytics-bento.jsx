      ...
      <div className="relative overflow-hidden rounded-[28px] bg-card p-7 pb-5 shadow-[0_2px_8px_rgba(0,0,0,0.08),0_0_0_1px_rgba(0,0,0,0.04)] dark:shadow-[0_2px_8px_rgba(0,0,0,0.2),0_0_0_1px_rgba(255,255,255,0.05)]">
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <p className="text-[15px] font-medium tracking-wide text-muted-foreground">People in the community</p>
            <h2 className="mt-1.5 text-[46px] font-semibold leading-[1] tracking-[-0.02em] text-card-foreground">
              1050
            </h2>
            <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-navy/20 bg-background/40 px-4 py-2 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_4px_12px_rgba(0,0,0,0.03)] dark:shadow-[0_1px_3px_rgba(0,0,0,0.2),0_1px_3px_rgba(255,255,255,0.05)]">
              <span className="text-[14px] font-semibold text-foreground">+ 1k in the half of year</span>
